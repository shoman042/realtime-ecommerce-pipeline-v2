...
* **متى نستخدمها (When to use):** نستخدمها عندما نتعامل مع "بيانات متدفقة" (Streaming Data) بسرعة كبيرة، ونحتاج لضمان عدم ضياع أي بيان في حالة توقف أو بطء النظام المعالج وفي انظمه ال (real time) .
...
* **متى نستخدمها (When to use):** عندما نحتاج لإجراء عمليات تحويل وتنظيف معقدة (Transformations) على كميات هائلة من البيانات (big data) في وقت قياسي أو لحظي.
